                            ...
                            <div class="row">
                               ...
                               @error('fullname')<small class="text-danger">{{$message}}</small>@enderror
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="tel" wire:model="phone" class="form-control" placeholder="Enter Phone Number" />
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model="zipcode" class="form-control" placeholder="Enter Zip-code" />
